...
public class TaxiOrderTestSuite {
    ...
    public void testMyTaxiWithChildSeatGetDescription() {
        ...
        String description = theOrder.getDescription();
        //Then
        assertEquals("Drive a course by MyTaxi Network + a child seat", description);
    }
    @Test
    ...
    public void testUberWithTwoChildSeatsGetDescription() {
        ...
        String description = theOrder.getDescription();
        //Then
        assertEquals("Drive a course by Uber Network + a child seat + a child seat", description);
    }
    @Test
    ...
    public void testVipTaxiWithChildSeatExpressGetDescription() {
        ...
        String description = theOrder.getDescription();
        //Then
        assertEquals("Drive a course by Taxi Network variant VIP + a child seat", description);
    }
}
